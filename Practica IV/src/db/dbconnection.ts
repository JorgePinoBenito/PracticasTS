...
import { CarSchema, SalespersonSchema, DealerSchema } from "./schema.ts";
...
export const SalespeopleCollection = db.collection<SalespersonSchema>("salespeople");
export const DealersCollection = db.collection<DealerSchema>("dealers");